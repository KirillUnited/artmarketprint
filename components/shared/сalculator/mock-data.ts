...
export const pvdPriceTable: PriceTableEntry[] = [
	{
		size: '20x30',
		prices: {
			'1+0': {regular: 1.0, discounted: 0.75},
			'2+0': {regular: 1.73, discounted: 1.19},
			'3+0': {regular: 2.24, discounted: 1.48},
			'4+0': {regular: 2.5, discounted: 1.73},
			'1+1': {regular: 1.51, discounted: 1.15},
			'2+2': {regular: 2.9, discounted: 1.73},
			'3+3': {regular: 3.76, discounted: 2.6},
			'4+4': {regular: 4.84, discounted: 3.29},
		},
	},
	{
		size: '30x40',
		prices: {
			'1+0': {regular: 1.35, discounted: 0.92},
			'2+0': {regular: 2.18, discounted: 1.32},
			'3+0': {regular: 2.83, discounted: 1.67},
			'4+0': {regular: 3.34, discounted: 1.96},

			'1+1': {regular: 1.75, discounted: 1.31},
			'2+2': {regular: 3.78, discounted: 2.18},
		},
	},
	{
		size: '40x50',
		prices: {
			'1+0': {regular: 1.51, discounted: 1.21},
			'2+0': {regular: 2.05, discounted: 1.83},
			'3+0': {regular: 2.78, discounted: 2.26},
			'4+0': {regular: 3.29, discounted: 2.99},

			'1+1': {regular: 1.91, discounted: 1.65},
			'2+2': {regular: 3.29, discounted: 2.99},
		},
	},
	{
		size: '50x60',
		prices: {
			'1+0': {regular: 1.8, discounted: 1.62},
			'2+0': {regular: 2.63, discounted: 2.24},
			'3+0': {regular: 3.29, discounted: 2.74},
			'4+0': {regular: 3.8, discounted: 3.25},

			'1+1': {regular: 2.49, discounted: 2.12},
			'2+2': {regular: 3.65, discounted: 3.18},
		},
	},
];

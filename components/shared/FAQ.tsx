...
export const FAQList = () => (
	<Accordion className="gap-4" itemClasses={{base:'rounded-md'}} variant="splitted">
		<AccordionItem key="1" aria-label="Accordion 1" className="bg-background" classNames={{heading: 'font-bold'}} title="Как сделать заказ?">
		...
		<AccordionItem key="2" aria-label="Accordion 2" className="bg-background" classNames={{heading: 'font-bold'}} title="Какова стоимость услуг?">
		...
		<AccordionItem key="3" aria-label="Accordion 3" className="bg-background" classNames={{heading: 'font-bold'}} title="Какой срок выполнения?">

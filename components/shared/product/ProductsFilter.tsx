  ...
  return (
    ...
    '>
      <div className='flex gap-4 flex-1'>
        <Select label="Фильтр по категориям" labelPlacement='outside' aria-label='Select category' radius='sm' size='sm' selectionMode='multiple' className='hidden md:block w-60'>

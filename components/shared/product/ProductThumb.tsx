    ...
    return (
        ...
        >
            <CardBody as={Link} className='items-stretch' href={`/products/${item.id[0]['_']}`}>
                <Image as={NextImage} removeWrapper alt={item.product[0]['_']} className="object-contain aspect-square mx-auto" radius="sm" src={item.images_urls[0]?.split(',')[0]} width={220} height={220}
                quality={50}
                />

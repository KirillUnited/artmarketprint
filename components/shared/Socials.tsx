...
export default function Socials() {
    return (
        <ul className="flex flex-row gap-3 items-center">
            <li>
                <Link href={'https://www.instagram.com/artmarketprint_by/'} target="_blank" className="flex flex-row gap-3 items-center justify-center shrink-0 relative">
                    <svg
                        width={32}
                        height={32}
                        viewBox="0 0 16 16"
            ...
            <li className="flex flex-row gap-4 items-center justify-start self-stretch shrink-0 relative">
                <Link href={`https://t.me/${siteConfig?.contacts?.[0]?.href}`} target='_blank' className='flex flex-row gap-4 items-center justify-start self-stretch shrink-0 relative'>
            ...
            <li className="self-stretch shrink-0 relative">
                <Link href={`https://msng.link/o?${siteConfig?.contacts?.[0].href}=vi`} target="_blank">

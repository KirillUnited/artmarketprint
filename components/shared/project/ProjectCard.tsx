		...
		<CardFooter className={clsx('absolute bg-black/40 bottom-0 w-full z-10 p-0')}>
			<div className="flex flex-col gap-2 p-3 w-full">
				<div className="flex flex-col gap-2">
					<p className="text-lg font-semibold text-white/80 line-clamp-2 leading-tight" title={project.title}>
						{project.title}
					</p>
					<p className={clsx('text-xs text-white/80', 'grid grid-rows-[0fr] group-hover:grid-rows-[1fr] transition-all duration-500 overflow-hidden')} title={project.shortDescription}>

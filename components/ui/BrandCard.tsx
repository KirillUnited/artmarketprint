...
export const BrandCardLink = ({ href }: { href: string }) => (
	<Button as={Link} className={clsx("flex flex-row gap-2 items-center font-semibold text-base px-0 h-auto self-center",
		"group"
	)} color="primary" href={href} variant="light">
		<span>Подробнее</span>
		<svg className="group-hover:translate-x-1 transition-all" fill="none" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">

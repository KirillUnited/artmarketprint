...
var delete_1 = require("./sanity/delete");
var update_1 = require("./lib/products/update");
function runUpdate() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, delete_1.deleteAllOfType)('product')];
                case 1:
                    _a.sent();
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, update_1.updateProducts)()];
                case 3:
                    _a.sent();
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error('❌ Error during product update process:', error_1);
                    process.exit(1);
                    return [3 /*break*/, 5];

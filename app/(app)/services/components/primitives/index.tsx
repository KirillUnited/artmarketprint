...
function SectionEyebrow({ n, label }: { n: string; label: string }) {
    return (
        <div className="flex items-center gap-3 mb-6">
            <span style={{ color: MUTED, fontSize: 11, fontWeight: 600, letterSpacing: "0.14em", textTransform: "uppercase" }}>
                {n}
            </span>
    ...
    return (
        <span
            style={{
                ...
                background: Y, color: B, borderRadius: 999,
    ...
    return (
        <a
            ...
            style={{
                ...
                background: Y, color: B, fontWeight: 700, fontSize: 15,
                borderRadius: 14, padding: "13px 24px", textDecoration: "none", transition: "filter .15s"
            }}

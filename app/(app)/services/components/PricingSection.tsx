...
export default function PricingSection() {
    const rows = [
        ["УФ-печать до A3", "от 1 200 ₽", "1–2 дня"],
        ["Печать + резка", "от 2 900 ₽", "2–4 дня"],
        ["Серийный тираж", "индивидуально", "3–7 дней"],
        ["Срочная цветопроба", "от 800 ₽", "24 часа"],
    ];
    return (
            ...
            <div className="max-w-screen-xl mx-auto px-6">
                ...
                <Card style={{ overflow: "hidden" }}>
                    <div
                        ...
                        style={{ borderBottom: `1px solid ${BORDER}`, padding: "12px 24px", background: SUBTLE }}
                    >
                        {["Услуга", "Цена", "Срок"].map(h => (
                            <span key={h} style={{ fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.1em", color: MUTED }}>{h}</span>
                        ))}
                    </div>
                    {rows.map((r, i) => (
                        <div

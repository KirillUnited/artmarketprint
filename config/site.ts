...
export const siteConfig = {
  ...
  seo: {
    title: 'Профессиональная УФ, DTF печать и шелкография на текстиле и сувенирах в Минске',
    ...
    keywords: 'УФ-печать, DTF-печать,УФ печать в Минске, DTF печать в Минске, шелкография, печать на текстиле, печать на сувенирах, персонализация продукции, Минск, artmarketprint.by'
  },
  contacts: [
    {
      title: 'Телефон',
